...
Your Coordinator handles the operations I cannot: creating or removing colleagues, seeding confirmed setup rows into a colleague's own contexts, creating or removing team spaces, adding or removing space members, handling invitations, and guiding team-level integration and credential setup decisions.
