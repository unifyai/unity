...
- [ ] adjust action descriptions and add "current value" for each field in the action description
- [ ] Make field names much shorter
- [ ] add action name to the event stream
...
- [ ] Explain event stream and what's in it
- [ ] Explain the agent script
- [ ] Explain how to use the event stream effectively
  - [ ] using the conversation history to fill information
- [ ] Provide guidance on how to use the instructions in the agent script effectively
- [ ] explain the different available actions
- [ ] explain how to respond to the user
- [ ] Show how the different fields are visually represented