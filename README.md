...
**Prerequisites**: [Install](https://redis.io/docs/latest/operate/oss_and_stack/install/install-stack/) `redis` locally. Run `redis-cli` for spinning up an instance. `test_controller.py` should be out of the box once this step is done.
