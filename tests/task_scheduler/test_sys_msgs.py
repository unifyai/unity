...
def test_ask_prompt_is_stable_across_serial_builds():
    ...
    test_ctx = f"tests/task_scheduler/test_sys_msgs/test_ask_prompt_is_stable_across_serial_builds/{DEFAULT_USER_CONTEXT}/{DEFAULT_ASSISTANT_CONTEXT}"
...
def test_update_prompt_is_stable_across_serial_builds():
    ...
    # Build a test-specific context path matching _handle_project pattern
    test_ctx = f"tests/task_scheduler/test_sys_msgs/test_update_prompt_is_stable_across_serial_builds/{DEFAULT_USER_CONTEXT}/{DEFAULT_ASSISTANT_CONTEXT}"
