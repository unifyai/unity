...
@_handle_project
@pytest.mark.asyncio
async def test_detection_consolidates_speech_with_subsequent_visual_outcome(mocked_manager):
    """
    ...
    with patch.object(manager._image_manager, "add_images", return_value=[mock_handle]):
        turn_state = TurnState(
            speech_events=[{"payload": {"content": "clicking submit", "start_time": 10.0}}],
