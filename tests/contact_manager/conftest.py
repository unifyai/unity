...
def _setup_scenario(
    ...
    ContactManager.__init__ calls _provision_system_overlays(), which creates
    ...
    # via _provision_system_overlays(). This must be serialized to avoid racing
...
async def contact_read_scenario(
    ...
    Uses context: tests/contact/ReadScenario
...
async def contact_mutation_scenario(
    ...
    Uses context: tests/contact/MutationScenario
