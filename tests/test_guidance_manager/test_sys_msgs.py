...
def test_ask_prompt_stable():
    ...
    test_ctx = f"tests/test_guidance_manager/test_sys_msgs/test_ask_prompt_stable/{DEFAULT_USER_CONTEXT}/{DEFAULT_ASSISTANT_CONTEXT}"
...
def test_update_prompt_stable():
    ...
    # Build a test-specific context path matching _handle_project pattern
    test_ctx = f"tests/test_guidance_manager/test_sys_msgs/test_update_prompt_stable/{DEFAULT_USER_CONTEXT}/{DEFAULT_ASSISTANT_CONTEXT}"
