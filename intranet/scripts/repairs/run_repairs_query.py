...
Usage:
    ...
    python intranet/scripts/repairs/run_repairs_query.py --query no_access_rate --params '{"return_absolute": true}'
...
# Add parent scripts directory to path for utils import
...
from intranet.core.bespoke_repairs_agent import (
    BespokeRepairsAgent,
...
def print_queries_list(queries: list) -> None:
    ...
    print("─" * 65)
    print(
        "💡 Usage: python intranet/scripts/repairs/run_repairs_query.py --query <query_id>",
    )
    print()
...
See README.md for comprehensive usage documentation.
    ...
    if not args.query:
        ...
        print()
        print("💡 Try: python intranet/scripts/repairs/run_repairs_query.py --list")
        return 1
