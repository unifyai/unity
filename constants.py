...
CMD_SCROLL_DOWN = "scroll_down_*"
CMD_SCROLL_UP = "scroll_up_*"
CMD_SEARCH = "search_*"
CMD_OPEN_URL = "open_url_*"
...
CMD_CLICK_BUTTON = "click_button_*"
CMD_SELECT_TAB = "select_tab_*"
CMD_CLOSE_TAB = "close_tab_*"
